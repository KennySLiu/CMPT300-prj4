...
.ascii "->__NR_syscall_max $342 sizeof(syscalls_64) - 1"	#
# 0 "" 2
# 74 "arch/x86/kernel/asm-offsets_64.c" 1
	
.ascii "->NR_syscalls $343 sizeof(syscalls_64)"	#
# 0 "" 2
...
.ascii "->TASK_threadsp $2464 offsetof(struct task_struct, thread.sp)"	#
# 0 "" 2
...
.ascii "->TASK_addr_limit $2600 offsetof(struct task_struct, thread.addr_limit)"	#
# 0 "" 2
